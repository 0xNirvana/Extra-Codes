...
sorted_input = (sorted(char_values.items(), key=lambda x:x[1], reverse=True))

# print sorted_input
input_precedence =''
for i in range(len(sorted_input)):
	input_precedence += sorted_input[i][0]
# print "Input Precedence:	", input_precedence
# print "Natural Precedence:	", "".join(natural_precedence)


change_val = 0

for val in encrypted_key:
	i = input_precedence.index(val)
	decrypted_key += natural_precedence[i]
